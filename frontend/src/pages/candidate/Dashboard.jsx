...
import { FaFileAlt, FaClock, FaCheckCircle, FaHeart, FaBriefcase } from 'react-icons/fa';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="card bg-gradient-to-br from-blue-500 to-blue-600 text-white">
          <div className="flex items-center justify-between">
            ...
            <FaFileAlt className="text-5xl text-blue-200" />
          </div>
        </div>
        ...
        <div className="card bg-gradient-to-br from-purple-500 to-purple-600 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{stats?.shortlistedApplications || 0}</p>
            </div>
        ...
        <div className="card bg-gradient-to-br from-green-500 to-green-600 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{stats?.acceptedApplications || 0}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Link 
          ...
          className="card hover:shadow-xl transition-shadow cursor-pointer border-2 border-red-200 hover:border-red-500"
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">{stats?.bookmarkedJobsCount || 0} saved jobs</p>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="card">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to="/candidate/applications" className="text-primary-600 hover:text-primary-700 font-medium">
            View All
          </Link>
        </div>
